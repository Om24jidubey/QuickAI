...
//                 onClick={() => setSidebar(false)}
//                 className={({ isActive }) =>
//                   `px-3.5 py-2.5 flex items-center gap-3 rounded-lg mb-1 transition-all duration-200
...
//               <p className='text-xs text-gray-500'>
//                 {has?.({ plan: 'premium_user' }) ? 'Premium' : 'Free'} Plan
//               </p>
//             </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between shrink-0 bg-white'>
