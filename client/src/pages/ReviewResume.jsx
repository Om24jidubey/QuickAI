        ...
        </div>
        {
          !content ? (
            ...
            <div className='mt-3 h-full overflow-y-scroll text-sm text-slate-600'>
              <div className='leading-7 text-sm text-slate-700'>
                <Markdown
                  components={{
                    h1: ({ node, ...props }) => (
                      <h1 className="text-xl font-bold mb-4 text-slate-800" {...props} />
                    ),
                    h2: ({ node, ...props }) => (
                      <h2 className="text-lg font-semibold mt-5 mb-2 text-slate-700" {...props} />
                    ),
                    ul: ({ node, ...props }) => (
                    ...
                    p: ({ node, ...props }) => (
                      <p className="mb-3 text-slate-600" {...props} />
                    ),
                  }}
                >
                  {content}
